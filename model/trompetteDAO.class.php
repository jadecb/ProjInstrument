...
class TrompetteDAO{
  ...
  function __construct() {
    ...
    function getTrompette(int $numArticle) : array{
        ...
        $req = 'SELECT ia.numarticle, ia.nom, ia.prix, ii.materiauxprincipal, ii.couleur, ii.largeur, ii.longueur, ii.hauteur, t.nbrTouche FROM infoArticle ia, infoInstrument ii, trompette t where ia.numArticle='.$numArticle.' AND ii.numArticle='.$numArticle.' AND b.numArticle='.$numArticle;
