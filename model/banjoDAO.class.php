...
class BanjoDAO{
    ...
    function getAllBanjo() : array{
        $dao = new BanjoDAO(); // instancie l'objet DAO
        $req = 'SELECT ia.numarticle, ia.nom, ia.prix, ii.materiauxprincipal, ii.couleur, ii.largeur, ii.longueur, ii.hauteur, a.nbrCordes FROM infoArticle ia, infoInstrument ii, Banjo a WHERE ia.numArticle=ii.numArticle AND ia.numArticle=a.numarticle';
        $sth = $this->db->query($req);
